...
ENV NGINX_ENVSUBST_FILTER='^(API_HOST|API_PORT|WEB_HOST|WEB_PORT|PERPLEXITY_BACKEND_HOST|PERPLEXITY_BACKEND_PORT|PERPLEXITY_FRONTEND_HOST|PERPLEXITY_FRONTEND_PORT|GOVERNOR_HOST|GOVERNOR_PORT|CRAWL_HOST|CRAWL_PORT|SIMULATION_HOST|SIMULATION_PORT|SKILLS_HOST|SKILLS_PORT)$'
